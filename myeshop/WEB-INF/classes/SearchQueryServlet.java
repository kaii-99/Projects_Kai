...
@WebServlet("/querysearch")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class SearchQueryServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
         ...
         String sqlStr = "SELECT * FROM laptops WHERE brand = ? OR model LIKE ? ";
         PreparedStatement pstmt = conn.prepareStatement(sqlStr);
         pstmt.setString(1, request.getParameter("searchword"));
         pstmt.setString(2, request.getParameter("searchword")+'%');
             ...
             do {
               if (rset.getString("brand").equals(checkbrand)) {
                  out.println("<tr>\r\n" +//
                              ...
                              "Qty: <input type=\"number\" name=\"qty\" value=\"0\" min=\"0\" max=\""+rset.getString("qty")+"\"></td>\r\n" +//
                              "</tr>");
               }
               else {
